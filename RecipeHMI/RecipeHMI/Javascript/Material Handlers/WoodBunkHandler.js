...
function deleteWoodBunk(controlNum) {
    ...
    let element = TcHmi.Controls.get(`WoodBunkMaterials_${controlNum}`);
...
function recoverWoodBunkElements(arr) {
    ...
    for (let i = 0; i < arr.length; i++) { //recreate material controls
        ...
        TcHmi.Controls.get(`WoodBunkMaterials_${i}.WoodBunkPosition`).setValue(position);
        TcHmi.Controls.get(`WoodBunkMaterials_${i}.WoodBunkSelectTop`).setSelectedIndex(dataIndex);
        TcHmi.Controls.get(`WoodBunkMaterials_${i}.WoodBunkSelectSides`).setSelectedIndex(dataIndex);
        TcHmi.Controls.get(`WoodBunkMaterials_${i}.WoodBunkSelectBottom`).setSelectedIndex(dataIndex);
